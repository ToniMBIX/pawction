...
<head>
    ...
    <title>Pawction - Subasta reabierta</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background:white; border-radius:12px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:30px 40px; color:#333; font-size:16px; line-height:1.6;">
                            ...
                            <p>
                                La subasta siguiente ha sido reabierta porque el ganador anterior no completó el pago a tiempo.
                            </p>
                            ...
                            <p><strong>Precio actual:</strong> {{ $auction->current_price }} €</p>

                            <div style="text-align:center; margin:30px 0;">
                                <a href="{{ env('FRONTEND_URL', 'http://localhost:5173') }}/auctions/{{ $auction->id }}"
                                   style="background:#2563eb; color:white; text-decoration:none; padding:14px 24px; border-radius:8px; display:inline-block; font-weight:700;">
                                    Ver subasta
                                </a>
                            </div>
                            ...
                            <p style="text-align:center; font-size:15px;">
                                🐾 Gracias por formar parte de <strong>Pawction</strong>.
                            </p>
