                    ...
                    <tr>
                        <td style="padding:30px 40px; color:#333; font-size:16px; line-height:1.6;">
                            ...
                            <p style="margin-top:0;">
                                Hola <strong><?php echo e($shipping->full_name); ?></strong>,
                            </p>
                            ...
                            <h2 style="font-size:22px; margin:25px 0 10px 0; text-align:center;">
                                <?php echo e($auction->product->name ?? 'Artículo subastado'); ?>

                            </h2>

                            <p><strong>Total pagado:</strong> <?php echo e($auction->current_price); ?> €</p>
                            ...
                            <?php if($shipping): ?>
                                <p style="text-align:center; line-height:1.5;">
                                    <strong><?php echo e($shipping->full_name); ?></strong><br>
                                    <?php echo e($shipping->address); ?><br>
                                    <?php echo e($shipping->postal_code); ?> <?php echo e($shipping->city); ?><br>
                                    <?php echo e($shipping->province); ?>, <?php echo e($shipping->country); ?><br>
                                    <strong>Tel:</strong> <?php echo e($shipping->phone); ?>
...
<?php /**PATH C:\Users\toni-\pawction\pawction\backend\resources\views/emails/payment_completed.blade.php ENDPATH**/ ?>